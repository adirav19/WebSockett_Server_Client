            ...
            using (ClientWebSocket client = new ClientWebSocket())
            {
                ...
                try
                {
                    ...
                    while(client.State == WebSocketState.Open)
                    {
                        ...
                        {
                            ArraySegment<byte> byeToSend = new ArraySegment<byte>(Encoding.UTF8.GetBytes(message));
                            await client.SendAsync(byeToSend,WebSocketMessageType.Text,true,cTs.Token);
